...
public class MyArea extends FragmentActivity implements OnMapReadyCallback {
    ...
    public void onMapReady(GoogleMap googleMap) {
        ...
        mMap.addMarker(new MarkerOptions().position(pos).title("Name").snippet("Contact Number"));
...
public class MyArea extends AppCompatActivity implements
